	...
	<div class="main-container">
		<div class="main wrapper clearfix">
			...
			<center>
				...
				<br /> Tags : <br />
				<c:forEach var="tag" items="${slika.tagsPhotos}">
					<table>
						<tr>
							<td>${tag.text}</td>
							<c:if test="${user.id==vlasnikSlike.id && user!=null}">
				...
				<c:forEach var="komentar" items="${slika.photoComments}">
					<table>
						...
						<tr>
							...
							<td><a
									href="./DeleteCommentController?komentarId=${komentar.id}&slikaId=${slika.id}">delete
										comment</a></td>
							</c:if>
						</tr>
					</table>
